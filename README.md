...
**Live Web App:**
https://salonix-eight.vercel.app/
...
```
The --tunnel option allows the mobile application to connect even when the device is not connected to the same Wi-Fi network as the development computer.
